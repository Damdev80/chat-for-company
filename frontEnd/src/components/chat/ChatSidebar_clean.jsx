    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between p-4 border-b border-[#3C4043] bg-[#252529]">
          <h1 className="text-xl font-bold text-[#A8E6A3] drop-shadow-sm">Thinkchat</h1>
              ...
              {filteredGroups.map((group) => (
                <div key={group.id} className="relative group">
                  ...
                  {showGroupOptions === group.id && (
                    <div className="absolute right-0 top-full mt-1 w-48 bg-[#2C2C34] border border-[#3C4043] rounded-xl shadow-2xl z-10 overflow-hidden">
                      <button
      ...
      {/* Modales para crear/editar grupos */}
      {showCreateModal && (
